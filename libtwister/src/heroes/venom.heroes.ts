...
export const Venom: Record<HeroNames, IHero> = {
  CARNAGE: {
    ...
    keywords: [
      ...
      VenomKeywords.Digest,
      VenomKeywords.Indigestion,
    ],
  },
  VENOM: {
  ...
  VENOM_ROCKET: {
    ...
    cardType: CardType.HERO,
    gameSet: GameSets.VENOM,
    keywords: [DeadpoolKeywords.ExcessiveViolence, VenomKeywords.Digest],
  },
  VENOMIZED_DR_STRANGE: {
