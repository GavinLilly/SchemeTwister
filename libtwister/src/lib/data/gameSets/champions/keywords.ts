...
import { SIZE_CHANGING as CivilWarSizeChanging } from '../civilWar/keywords';

export const CHEERING_CROWDS: IKeyword = {
  name: KeywordName.CHEERING_CROWDS,
  id: 'f4a0c0bc-1ab2-4848-9329-325886b601ca',
...
export const SIZE_CHANGING: IKeyword = {
  ...
  id: '0db5201c-caed-4c89-bb7a-0b816b194c06',
  description: `${CivilWarSizeChanging.description}
---
<ul>
