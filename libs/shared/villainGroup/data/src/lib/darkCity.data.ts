...
type VillainGroupNames = 'EMISSARIES_OF_EVIL' | 'FOUR_HORSEMEN' | 'MARAUDERS' | 'MLF' | 'STREETS_OF_NEW_YORK' | 'UNDERWORLD';

export const DarkCityVillainGroups: Record<VillainGroupNames, IVillainGroup> = {
  EMISSARIES_OF_EVIL: {
