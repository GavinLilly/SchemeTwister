import { HeroModel, Team } from '@legendizer/shared/hero/types';
import { GameSet } from '@legendizer/shared/gameSet/data';
import { CardType } from '@legendizer/shared/base/types';

export class LegendaryHeroes extends HeroModel {
  public static BLACK_WIDOW = new LegendaryHeroes({
  ...
  public static CAPTAIN_AMERICA = new LegendaryHeroes({
  ...
  public static CYCLOPS = new LegendaryHeroes({
  ...
  public static DEADPOOL = new LegendaryHeroes({
  ...
  public static EMMA_FROST = new LegendaryHeroes({
  ...
  public static GAMBIT = new LegendaryHeroes({
  ...
  public static HAWKEYE = new LegendaryHeroes({
  ...
  public static HULK = new LegendaryHeroes({
  ...
  public static IRON_MAN = new LegendaryHeroes({
  ...
  public static NICK_FURY = new LegendaryHeroes({
  ...
  public static ROGUE = new LegendaryHeroes({
  ...
  public static SPIDER_MAN = new LegendaryHeroes({
  ...
  public static STORM = new LegendaryHeroes({
  ...
  public static THOR = new LegendaryHeroes({
  ...
  public static WOLVERINE = new LegendaryHeroes({
