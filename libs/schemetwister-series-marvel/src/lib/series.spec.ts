...
const BIG_BOX_COUNT = 5;
const MEDIUM_BOX_COUNT = 3;
const SMALL_BOX_COUNT = 19;
...
describe('Marvel series', () => {
  ...
  beforeAll(() => {
    libTwister = new LibTwister(marvelSeries);
  });
  ...
  it('should create a LibTwister instance with all Game Sets', () =>
    expect(libTwister.selectedGameSets).toHaveLength(GAME_SET_COUNT));
});
