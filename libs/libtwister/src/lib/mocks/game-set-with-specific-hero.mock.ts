...
import { RequireCardName } from '../model/schemes/cardInDeck/require-card-name.behaviour';
import { RequireHero } from '../model/schemes/cardInDeck/require-hero.behaviour';
