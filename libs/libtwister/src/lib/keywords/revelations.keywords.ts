...
import {
  DARK_MEMORIES,
  DOUBLE_SIDED_TRANSFORMING_SCHEMES,
  HYPERSPEED,
  LAST_STAND,
  LOCATIONS,
} from './baseKeywords';
...
export const DarkMemories: IKeyword = {
  ...DARK_MEMORIES,
...
export const LastStand: IKeyword = {
  ...LAST_STAND,
...
export const DoubleSidedTransformingSchemes: IKeyword = {
  ...DOUBLE_SIDED_TRANSFORMING_SCHEMES,
