...
class NoirScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const FIND_THE_SPLIT_PERSONALITY_KILLER = new NoirScheme(
  {
...
export const SILENCE_THE_WITNESSES = new NoirScheme(
  {
...
export const FIVE_FAMILIES_OF_CRIME = new NoirScheme(
  {
...
export const HIDDEN_HEART_OF_DARKNESS = new NoirScheme(
  {
