...
export const WORTHY: IKeyword = {
  name: KeywordName.WORTHY,
  id: 'eb8289e1-2c2e-448e-988e-bd7e5dea396d',
...
export const VILLAINOUS_WEAPONS: IKeyword = {
  name: KeywordName.VILLAINOUS_WEAPONS,
  id: '07e8ceae-32f4-436a-a6dc-ebb3fc6b195d',
