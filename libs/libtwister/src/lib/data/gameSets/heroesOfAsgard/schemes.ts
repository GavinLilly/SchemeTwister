...
class HeroesOfAsgardScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const ASGARDIAN_TEST_OF_WORTH = new HeroesOfAsgardScheme(
  {
...
export const THE_DARK_WORLD_OF_SVARTALFHEIM = new HeroesOfAsgardScheme(
  {
...
export const RAGNAROK_TWILIGHT_OF_THE_GODS = new HeroesOfAsgardScheme(
  {
...
export const WAR_OF_THE_FROST_GIANTS = new HeroesOfAsgardScheme(
  {
