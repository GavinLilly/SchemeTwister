...
export const AGE_OF_ULTRON: NewScheme = {
...
export const PULL_EARTH_INTO_MEDIEVAL_TIMES: NewScheme = {
...
export const TRANSFORM_COMMUTERS_INTO_GIANT_ANTS: NewScheme = {
...
export const TRAP_HEROES_IN_THE_MULTIVERSE: NewScheme = {
