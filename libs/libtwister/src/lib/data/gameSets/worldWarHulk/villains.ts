...
export const ASPECTS_OF_THE_VOID: IVillainGroup = {
...
export const CODE_RED: IVillainGroup = {
...
export const ILLUMINATI: IVillainGroup = {
...
export const INTELLIGENCIA: IVillainGroup = {
...
export const SAKAAR_IMPERIAL_GUARD: IVillainGroup = {
...
export const UFOES: IVillainGroup = {
