...
class MessiahComplexScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const HACK_CEREBRO_SERVERS_TO = new MessiahComplexScheme(
  {
...
export const RAID_GENE_BANK_TO = new MessiahComplexScheme(
  {
...
export const HIRE_SINGULARITY_INVESTIGATIONS_TO = new MessiahComplexScheme(
  {
...
export const DRAIN_MUTANTS_POWERS_TO = new MessiahComplexScheme(
  {
