...
class CaptainAmericaScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const BRAINWASH_THE_MILITARY = new CaptainAmericaScheme(
  {
...
export const CHANGE_THE_OUTCOME_OF_WWII = new CaptainAmericaScheme(
  {
...
export const GO_BACK_IN_TIME_TO_SLAY_HEROES_ANCESTORS =
  new CaptainAmericaScheme(
    {
...
export const THE_UNBREAKABLE_ENIGMA_CODE = new CaptainAmericaScheme(
  {
