...
export const ANTI_MUTANT_HATRED: ShortScheme = {
...
export const THE_DARK_PHOENIX_SAGA: ShortScheme = {
...
export const HORROR_OF_HORRORS: ShortScheme = {
...
export const MUTANT_HUNTING_SUPER_SENTINELS: ShortScheme = {
...
export const NUCLEAR_ARMAGEDDON: ShortScheme = {
...
export const TELEVISED_DEATHTRAPS_OF_MOJOWORLD: ShortScheme = {
...
export const XMEN_DANGER_ROOM_GOES_BERSERK: ShortScheme = {
