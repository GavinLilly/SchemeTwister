...
export const ALIEN_BROOD_ENCOUNTER: NewScheme = {
...
export const ANTI_MUTANT_HATRED: NewScheme = {
...
export const THE_DARK_PHOENIX_SAGA: NewScheme = {
...
export const HORROR_OF_HORRORS: NewScheme = {
...
export const MUTANT_HUNTING_SUPER_SENTINELS: NewScheme = {
...
export const NUCLEAR_ARMAGEDDON: NewScheme = {
...
export const TELEVISED_DEATHTRAPS_OF_MOJOWORLD: NewScheme = {
...
export const XMEN_DANGER_ROOM_GOES_BERSERK: NewScheme = {
