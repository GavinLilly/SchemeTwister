...
export const THROWN_ARTIFACT: IKeyword = {
  name: KeywordName.THROWN_ARTIFACT,
  id: '1ca9729b-35ba-467d-acb6-bb2530175f6e',
...
export const URU_ENCHANTED_WEAPONS: IKeyword = {
  name: KeywordName.URU_ENCHANTED_WEAPONS,
  id: '2dcaab18-e50d-42f5-a2b3-332b5575f6eb',
