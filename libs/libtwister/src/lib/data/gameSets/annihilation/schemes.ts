...
class AnnihilationScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const PULSE_WAVES_FROM_THE_NEGATIVE_ZONE = new AnnihilationScheme(
  {
...
class SneakAttackTheHeroesHomesScheme extends AnnihilationScheme {
...
export const SNEAK_ATTACK_THE_HEROES_HOMES =
  new SneakAttackTheHeroesHomesScheme(
    {
...
export const PUT_HUMANITY_ON_TRIAL = new AnnihilationScheme(
  {
...
export const BREACH_PARALLEL_DIMENSIONS = new AnnihilationScheme(
  {
  ...
  rule.villainDeck.numBystanders = (rule.villainDeck.numBystanders || 0) + 4;
  return rule;
});
