...
export const WALL_CRAWL: IKeyword = {
  name: KeywordName.WALL_CRAWL,
  id: 'e5386351-fb13-490b-9169-0f667e8e4f79',
...
export const FEAST: IKeyword = {
  name: KeywordName.FEAST,
  id: '5a01e1c1-0dcd-4640-a07a-fad7cb2f0282',
