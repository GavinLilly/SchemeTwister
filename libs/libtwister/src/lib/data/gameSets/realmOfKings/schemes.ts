...
class RealmOfKingsScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const RUIN_THE_PERFECT_WEDDING = new RealmOfKingsScheme(
  {
...
export const WAR_OF_KINGS = new RealmOfKingsScheme(
  {
...
export const TORNADO_OF_TERRIGEN_MISTS = new RealmOfKingsScheme(
  {
...
export const DEVOLVE_WITH_XEROGEN_CRYSTALS = new RealmOfKingsScheme(
  {
