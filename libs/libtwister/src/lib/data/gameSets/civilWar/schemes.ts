...
class CivilWarScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const AVENGERS_VS_XMEN = new CivilWarScheme(
  {
...
export const DARK_REIGN_OF_HAMMER_OFFICERS = new CivilWarScheme(
  {
...
export const EPIC_SUPER_HERO_CIVIL_WAR = new CivilWarScheme(
  {
  ...
  6,
  6
).overrideEachRule((rule, numPlayers) => {
  if (numPlayers === 1) {
...
export const IMPRISON_UNREGISTERED_SUPERHUMANS = new CivilWarScheme(
  {
...
export const NITRO_THE_SUPERVILLAIN_THREATENS_CROWDS = new CivilWarScheme(
  {
...
export const PREDICT_FUTURE_CRIME = new CivilWarScheme(
  {
...
export const REVEAL_HEROES_SECRET_IDENTITIES = new CivilWarScheme(
  {
...
export const UNITED_STATES_SPLIT_BY_CIVIL_WAR = new CivilWarScheme(
  {
