...
class NewMutantsScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

class TheDemonBearSaga extends NewMutantsScheme {
  public async getSetup(
    ...
    const demons = (await import('./villains')).DEMONS_OF_LIMBO;
    const demonsPicked = villainStore.getOne(demons.id);
...
export const THE_DEMON_BEAR_SAGA = new TheDemonBearSaga(
  {
...
export const CRASH_THE_MOON_INTO_THE_SUN = new NewMutantsScheme(
  {
...
export const TRAPPED_IN_THE_INSANE_ASYLUM = new NewMutantsScheme(
  {
...
export const SUPERHUMAN_BASEBALL_GAME = new NewMutantsScheme(
  {
