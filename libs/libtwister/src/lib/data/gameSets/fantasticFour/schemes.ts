...
class FantasticFourScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const BATHE_THE_EARTH_IN_COSMIC_RAYS = new FantasticFourScheme(
  {
...
export const FLOOD_THE_PLANET_WITH_MELTED_GLACIERS = new FantasticFourScheme(
  {
...
export const INVINCIBLE_FORCE_FIELD = new FantasticFourScheme(
  {
...
export const PULL_REALITY_INTO_THE_NEGATIVE_ZONE = new FantasticFourScheme(
  {
