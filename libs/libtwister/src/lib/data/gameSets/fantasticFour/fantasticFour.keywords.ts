...
export const FOCUS: IKeyword = {
  name: KeywordName.FOCUS,
  id: '109740af-e1a3-48b1-b315-c7d1d0eb3279',
...
export const BURROW: IKeyword = {
  name: KeywordName.BURROW,
  id: '4c322755-a8cb-4d7c-bcf8-beb73ca268d9',
...
export const COSMIC_THREAT: IKeyword = {
  name: KeywordName.COSMIC_THREAT,
  id: '476f659a-2015-4a84-9b1a-3788afbe2671',
...
export const GALACTUS_COSMIC_THREAT: IKeyword = {
  name: KeywordName.GALACTUS_COSMIC_THREAT,
  id: 'a1176528-17b8-44f7-adbb-d5894d1aec94',
