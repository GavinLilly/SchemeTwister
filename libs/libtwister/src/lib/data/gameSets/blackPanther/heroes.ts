...
export const KING_BLACK_PANTHER: IHero = {
...
export const QUEEN_STORM_OF_WAKANDA: IHero = {
...
export const GENERAL_OKOYE: IHero = {
...
export const PRINCESS_SHURI: IHero = {
