...
export const ENEMIES_OF_ASGARD = new VillainGroup({
  id: 'dfe941c5-ed7f-4f2b-80ce-25435af90a5d',
  name: 'Enemies of Asgard',
  gameSet: META,
});

export const HYDRA = new VillainGroup({
  id: 'd7d0f179-b55a-42b8-8875-fbe633f27482',
  name: 'HYDRA',
  gameSet: META,
});

export const MASTERS_OF_EVIL = new VillainGroup({
  id: 'f55315f9-009b-4f6b-a999-7a745270980a',
  name: 'Masters of Evil',
  gameSet: META,
});

export const RADIATION = new VillainGroup({
  id: 'a3fe1ac8-8772-4161-9528-7c044687bc77',
  name: 'Radiation',
  gameSet: META,
});

export const SKRULLS = new VillainGroup({
  id: 'a3ee145c-54a6-4f76-8593-423a0a3360f0',
  name: 'Skrulls',
  gameSet: META,
});

export const SPIDER_FOES = new VillainGroup({
