...
import { CROSS_DIMENSIONAL_RAMPAGE } from '../worldWarHulk/worldWarHulk.keywords';
...
const hankPym = new EpicMastermindBuilder({
...
export const HANK_PYM_YELLOWJACKET = hankPym.buildNormal({
...
export const EPIC_HANK_PYM_YELLOWJACKET = hankPym.buildEpic({
...
export const KILLMONGER_THE_BETRAYER = killmonger.buildNormal({
...
export const EPIC_KILLMONGER_THE_BETRAYER = killmonger.buildEpic({
...
const ultronInfinity = new EpicMastermindBuilder({
...
export const ULTRON_INFINITY = ultronInfinity.buildNormal({
...
export const EPIC_ULTRON_INFINITY = ultronInfinity.buildEpic({
...
const zombieScarletWitch = new EpicMastermindBuilder({
...
export const ZOMBIE_SCARLET_WITCH = zombieScarletWitch.buildNormal({
...
export const EPIC_ZOMBIE_SCARLET_WITCH = zombieScarletWitch.buildEpic({
