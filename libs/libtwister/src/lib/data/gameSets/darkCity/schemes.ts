...
class DarkCityScheme extends AbstractScheme {
  public readonly gameSetId = META.id;
}

export const CAPTURE_BABY_HOPE = new DarkCityScheme(
  {
...
export const DETONATE_THE_HELICARRIER = new DarkCityScheme(
  {
...
export const MASSIVE_EARTHQUAKE_GENERATOR = new DarkCityScheme(
  {
...
class OrganizedCrimeWaveScheme extends DarkCityScheme {
  public async getSetup(
    ...
    const goons = (await import('./henchmen')).MAGGIA_GOONS;

    const goonsPicked = henchmenStore.getOne(goons.id);
...
export const ORGANIZED_CRIME_WAVE = new OrganizedCrimeWaveScheme(
  {
...
export const SAVE_HUMANITY = new DarkCityScheme(
  {
...
export const STEAL_THE_WEAPONIZED_PLUTONIUM = new DarkCityScheme(
  {
...
class TransformCitizensIntoDemonsScheme extends DarkCityScheme {
  public async getSetup(
    numPlayers: NumPlayers,
    selectedMastermind: AbstractMastermind,
    heroStore: MultiCardStore<IHero>,
    ...
    const jeanGrey = (await import('./heroes')).JEAN_GREY;

    const jgPicked = heroStore.getOne(jeanGrey.id);
...
export const TRANSFORM_CITIZENS_INTO_DEMONS =
  new TransformCitizensIntoDemonsScheme(
    {
...
export const XCUTIONERS_SONG = new DarkCityScheme(
  {
