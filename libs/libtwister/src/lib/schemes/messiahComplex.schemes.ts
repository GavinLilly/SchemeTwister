...
type SchemeNames =
  | 'HACK_CEREBRO_SERVERS_TO'
  | 'RAID_GENE_BANK_TO'
  | 'HIRE_SINGULARITY_INVESTIGATIONS_TO'
  | 'DRAIN_MUTANTS_POWERS_TO';

export const MessiahComplex: Record<SchemeNames, IScheme> = {
  HACK_CEREBRO_SERVERS_TO: new Scheme(
    {
...
4: This Scheme Transforms into a random Unveiled Scheme. Do it's Twist effect.`,
  ...
  HIRE_SINGULARITY_INVESTIGATIONS_TO: new Scheme(
    {
...
5: This Scheme Transforms into a random Unveiled Scheme. Do it's Twist effect.`,
  ...
  DRAIN_MUTANTS_POWERS_TO: new Scheme(
    {
