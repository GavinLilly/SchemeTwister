...
8-11: Put this Twist next to the Scheme as a "Moral Failing."`,
  ...
  THE_DARK_WORLD_OF_SVARTALFHEIM: {
    ...
    specialRules: 'Villains in city spaces with Eternal Darkness get +1 Attack. To recruit a Hero in an HQ space with Eternal Darkness, you must pay an extra 1 Recruit.',
